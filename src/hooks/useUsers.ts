...
export const useUsers = (options: UseUsersOptions = {}) => {
  ...
  const updateUser = async (userId: string, data: Partial<UserProfile>): Promise<boolean> => {
    ...
    try {
      ...
      vaniToast.success('Team member updated successfully');
  ...
  const suspendUser = async (userId: string): Promise<boolean> => {
    ...
    try {
      ...
      vaniToast.success('Team member suspended successfully');
  ...
  const activateUser = async (userId: string): Promise<boolean> => {
    ...
    try {
      ...
      vaniToast.success('Team member activated successfully');
  ...
  const resetUserPassword = async (userId: string): Promise<boolean> => {
    ...
    try {
      ...
      vaniToast.success('Password reset email sent');
      return true;
    } catch (err: any) {
  ...
  const assignRole = async (userId: string, roleId: string): Promise<boolean> => {
    ...
    try {
      ...
      vaniToast.success('Role assigned successfully');
  ...
  const removeRole = async (userId: string, roleId: string): Promise<boolean> => {
    ...
    try {
      ...
      vaniToast.success('Role removed successfully');
  ...
  const getUserActivity = async (userId: string, days: number = 30): Promise<UserActivity[]> => {
    try {
      ...
      vaniToast.error('Failed to load activity log');
      return [];
    }
  };
...
export const useCurrentUserProfile = () => {
  ...
  const updateProfile = async (data: Partial<UserProfile>): Promise<boolean> => {
    ...
    try {
      ...
      vaniToast.success('Profile updated successfully');
  ...
  const removeAvatar = async (): Promise<boolean> => {
    ...
    try {
      ...
      vaniToast.success('Avatar removed successfully');
      await fetchProfile();
      return true;
    } catch (err: any) {
  ...
  const changePassword = async (currentPassword: string, newPassword: string): Promise<boolean> => {
    ...
    try {
      ...
      vaniToast.success('Password changed successfully');
      return true;
    } catch (err: any) {
