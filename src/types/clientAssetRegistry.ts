// src/types/clientAssetRegistry.ts
// UI-layer domain types for Client Asset Registry (aligned with API clientAssetRegistryTypes)
...
export interface ClientAssetFormData {
  name: string;
  owner_contact_id: string;
  resource_type_id: string;
...
export const DEFAULT_CLIENT_ASSET_FORM_DATA: ClientAssetFormData = {
  name: '',
  owner_contact_id: '',
  resource_type_id: '',
  status: 'active',
