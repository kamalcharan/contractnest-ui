      ...
      <MiscPageWrapper>
        <Routes>
          ...
          >
            ...
            <Route path="settings/templates/new" element={<TemplateDesignerPage />} />
            <Route path="settings/templates/:id/edit" element={<TemplateDesignerPage />} />
            <Route path="settings/templates/:id/preview" element={<ComingSoonPage />} />
