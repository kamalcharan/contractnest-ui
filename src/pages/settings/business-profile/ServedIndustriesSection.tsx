...
// ════════════════════════════════════════════════════════════════════
// SERVED INDUSTRIES SECTION (used inside Business Profile sidebar)
// ════════════════════════════════════════════════════════════════════

const ServedIndustriesSection: React.FC = () => {
  const { isDarkMode, currentTheme } = useTheme();
  const colors = isDarkMode ? currentTheme.darkMode.colors : currentTheme.colors;
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-sm mt-1" style={{ color: colors.utility.secondaryText }}>
            Industries your business operates in
          </p>
        </div>
        <button
      ...
      {isLoading ? (
        ...
        >
          ...
          <p className="mb-6 max-w-md mx-auto" style={{ color: colors.utility.secondaryText }}>
            Add the industries your business serves to unlock industry-specific templates and improve your visibility in the marketplace.
          </p>
          <button
            onClick={() => setShowAddModal(true)}
