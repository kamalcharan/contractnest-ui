...
import { Pencil, Trash2, MapPin, Shield, AlertTriangle, XCircle } from 'lucide-react';
...
const EquipmentCard: React.FC<EquipmentCardProps> = ({ asset, onEdit, onDelete, disabled }) => {
