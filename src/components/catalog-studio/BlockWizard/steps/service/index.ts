// src/components/catalog-studio/BlockWizard/steps/service/index.ts
// Phase 6 & 7: Added BusinessRulesStep export
...
export { default as BusinessRulesStep } from './BusinessRulesStep';
