...
export interface FlyByBlockCardProps {
  ...
  isDragging?: boolean;
  dragHandleProps?: any;
  contractDurationDays?: number; // Contract duration in days for service cycle validation
...
const FlyByBlockCard: React.FC<FlyByBlockCardProps> = ({
  ...
  // Check if type has service cycle (service/spare, not unlimited, not hidden pricing)
  const hasServiceCycle = !hidePricing && (flyByType === 'service' || flyByType === 'spare') && !block.unlimited;
      ...
      {expanded && (
        ...
        >
          <div className="pt-3 space-y-4">
            ...
            {/* Service Cycle Interval - For Service, Spare (not unlimited) */}
            {hasServiceCycle && (
              <div
              ...
              >
                <div className="flex items-center gap-2 mb-2">
                  <Repeat className="w-3.5 h-3.5" style={{ color: typeConfig.color }} />
                  <label
